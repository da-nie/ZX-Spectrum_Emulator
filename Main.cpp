...
BOOL CWinApp_Main::InitInstance(void)
{
 ...
 RECT Rect;
 Rect.left=0;
 Rect.right=(256+BORDER_LEFT_RIGHT*8*2)*2;
 Rect.top=0;
 Rect.bottom=(192+BORDER_TOP_BOTTOM*8*2)*2;
 AdjustWindowRect(&Rect,WS_OVERLAPPED|WS_CAPTION|WS_SYSMENU|WS_MINIMIZEBOX,FALSE);
 cWnd_Main->CreateEx(0,ClassName,"Эмулятор ZX-Spectrum",WS_OVERLAPPED|WS_CAPTION|WS_SYSMENU|WS_MINIMIZEBOX,0,0,Rect.right-Rect.left,Rect.bottom-Rect.top,NULL,NULL);
